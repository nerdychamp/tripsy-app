export const ASSETS = {
  ...
  THUMBNAILS: [
    require('../../../assets/images/trip_thumbnails/1.png'),
    require('../../../assets/images/trip_thumbnails/2.png'),
    require('../../../assets/images/trip_thumbnails/3.png'),
    require('../../../assets/images/trip_thumbnails/4.png'),
